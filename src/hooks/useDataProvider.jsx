...
const KO_NAME_FALLBACK = {
  ...
  AGO:'어슈어드 개런티', AGX:'아건', AIG:'AIG', AII:'알몬티 인더스트리즈',
  ...
  GHTI:'GE 헬스케어 테크', GIL:'길단 액티브웨어', GILD:'길리어드 사이언스',
  GIS:'제너럴 밀스', GL:'글로브 라이프', GLBE:'글로벌-E', GLNG:'골라 LNG',
  GLO:'GXO 로지스틱스', GLOB:'글로반트', GLPI:'게이밍 앤 레저', GLW:'코닝',
  ...
  VRNS:'바로니스 시스템즈', VRNT:'베린트', VRSK:'버리스크', VRSN:'베리사인',
  ...
  FBNA:'퍼스트 뱅크셰어즈', FBPR:'퍼스트 뱅코프', FCBD:'퍼스트 캐쉬 뱅코프',
  ...
  IE:'이반호 일렉트릭', IEI:'인사이트 엔터프라이즈', IESC:'IES 홀딩스',
